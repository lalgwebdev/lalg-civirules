 ...
 */
class CRM_LalgCivirules_Upgrader_Base {

  /**
   * @var CRM_LalgCivirules_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_LalgCivirules_Upgrader(
        'lalg-civirules',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_LalgCivirules_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_LalgCivirules_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
